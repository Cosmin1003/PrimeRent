        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-all group">
            ...
            <Button 
              ...
              className="w-full bg-black hover:bg-emerald-600 h-12 rounded-xl font-bold"
            >
              View Requests
            </Button>
          </div>
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-md transition-all group">
            ...
            <p className="text-slate-500 mb-8">
              Add a new stay to your portfolio and start reaching more travelers.
            </p>
            <Button 
              onClick={() => navigate("/host/create-listing")}
              variant="outline"
              className="w-full border-slate-200 hover:border-emerald-600 hover:text-emerald-600 h-12 rounded-xl font-bold"
            >
              Add Property
            </Button>
          </div>
